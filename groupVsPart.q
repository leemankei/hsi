...
\ts meta st:`sym`time xasc o    // 1848 536871888
\ts meta s:`sym xasc o          // 388 469763520
\ts meta t:`time xasc o         // 1515 536871904
...
meta stp:update `p#sym from st  // p
meta sp:update `p#sym from s    // p
...
meta stg:update `g#sym from st  // g
meta sg:update `g#sym from s    // g    
meta tg:update `g#sym from t    // gs
